    ...
    return (
      <nav style={{
        ...
        <div style={{
          ...
          <div />
          <div style={{ display: "flex", gap: 8 }}>
            <NavLink href="#skills" id="skills" label="Skills" />
            <NavLink href="#projects" id="projects" label="Projects" />
            <NavLink href="#certifications" id="certifications" label="Certifications" />
    ...
    return (
      <nav style={{
        ...
        <div style={{
          ...
          {/* Removed left-side name as requested */}
          <div />
          <div style={{ display: "flex", gap: 8 }}>
            <NavLink href="#skills" label="Skills" />
            <NavLink href="#projects" label="Projects" />
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <NavLink href="#certifications" label="Certifications" />
            <NavLink href="#contact" label="Contact" />
            <NavLink href="/Manasapujha_Resume.pdf" label="Resume" download="Manasapujha_G_R_Resume.pdf" />
          </div>
        </div>
      </nav>
    );
      ...
      <nav style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: 8 }}>
            ...
            <NavLink href="#certifications" label="Certifications" />
            <NavLink href="#contact" label="Contact" />
            {/* Resume link: plain style but still downloads */}
            <NavLink href="/Manasapujha_Resume.pdf" label="Resume" download="Manasapujha_G_R_Resume.pdf" />
          </div>
        </div>
      </nav>
